...
import {onDelay} from "../../dist/esm/node.esm";
...
describe('TS: onDelay function', function () {
    ...
    it('should return an object with cancel method', function () {
        ...
        const result = onDelay(function () {}, 10) as DelayResult;
    ...
    it('should prevent callback execution when canceled', function (done) {
        ...
        const result: DelayResult = onDelay(function () {
