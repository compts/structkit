...
describe('TS: curry method', function () {
    ...
    it('check if curry with two param type number return boolean', function () {
        ...
        assert.strictEqual(typeof equal(curry(subtract, two)(two)(one))(zero), "boolean");
