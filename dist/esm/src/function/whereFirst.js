 ...
 *=>[{"s1":{"s2":2}}]
 */
function whereFirst (objectValue, objectValueWhere, func) {

    return whereLoopExecution(objectValue, objectValueWhere, func, true, 'where_first');

}
export default whereFirst;
